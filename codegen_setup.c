...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Destruction Derby Raw",
    .project_root_env = "DESTRUCTION_DERBY_RAW_PROJECT_ROOT",
    .build_dir_env = "DESTRUCTION_DERBY_RAW_BUILD_DIR",
    .force_setup_env = "DESTRUCTION_DERBY_RAW_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_009.12_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Destruction_Derby_Raw",
    .prepare_note =
